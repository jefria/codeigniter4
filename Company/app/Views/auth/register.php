            ...
            <div class="col-md-6 offset-md-3">
                <div class="card my-5">
                    ...
                    Swal.fire({
                        title: 'ERROR!',
                        icon: 'error',
                        html: <?= json_encode(implode('<br>', $validation->getErrors())) ?>
                    });
                    </script>
                    <?php endif; ?>


                    <form class="card-body cardbody-color p-lg-5" method="post" action="/auth/register">
                        <?= csrf_field() ?>
                        ...
                        <div id="emailHelp" class="form-text text-center mb-5 text-dark">Already have an account? <a
                                href="/login" class="text-dark fw-bold"> Log in.</a>
                        </div>
                    </form>
                </div>
